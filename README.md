...
본 프로젝트는 대한민국 공공데이터포털의 공식 데이터를 활용하였습니다.

* **데이터 소스:** [공공데이터포털 (data.go.kr)](https://www.data.go.kr/)
* **제공 기관:** 국민건강보험공단
* **데이터셋 명:** 국민건강보험공단_건강검진정보 (2024년 기준 최신 데이터)
* **데이터 규모:** 약 100만 건 (1,000,000 Rows)
* **포함 정보:** 성별, 연령대, 신장, 체중, 허리둘레, 혈압, 혈당, 총콜레스테롤, 흡연상태, 음주여부 등
